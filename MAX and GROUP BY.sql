...
SELECT MAX(TotalAmount) AS 'MaximumaAmount' FROM SALES;

SELECT MAX(SaleDate) AS 'MaximumSales' FROM SALES;

SELECT MAX(PaymentMethod) AS 'MaxPaymentMethod' FROM SALES;
...
SELECT DISTINCT SaleDate, max(TotalAmount) as 'MaximumTotalAmount'
FROM SALES
GROUP BY SaleDate;

SELECT  SaleDate, max(TotalAmount) as 'MaximumTotalAmount'
FROM SALES
GROUP BY SaleDate;
